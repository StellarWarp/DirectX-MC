...
public:
	...
	void SetSkyRoate(const DirectX::XMMATRIX& skyRoate);

	void SetSunView(const DirectX::XMMATRIX& sunView);

	void SetSunInfo(SkyEffect& skyEffect, float r, const DirectX::XMFLOAT3& color);
...
private:
	...
	DirectX::XMMATRIX m_SkyTransform;

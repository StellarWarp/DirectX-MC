...
void ShadowEffect::SetET_r0(float r0)
{
	if (r0 <= 0)
		pImpl->m_pEffectHelper->GetConstantBufferVariable("ET_enable")->SetUInt(0);
	else
	{
		pImpl->m_pEffectHelper->GetConstantBufferVariable("ET_enable")->SetUInt(1);
		pImpl->m_pEffectHelper->GetConstantBufferVariable("ET_r0")->SetFloat(r0);
	}
}
